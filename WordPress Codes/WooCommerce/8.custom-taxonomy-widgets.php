...
/* -----------------------------------------
    Register 'Custom Taxonomy' widget Start
-------------------------------------------*/
add_action('widgets_init', 'init_lc_taxonomy');
function init_lc_taxonomy()
{
    return register_widget('lc_taxonomy');
}
class lc_taxonomy extends WP_Widget
{
    ...
    {
        parent::WP_Widget('lc_taxonomy', $name = 'Custom Taxonomy Widget');
    }
    /**
     * This is the Widget
     **/
        ...
        <div class="lctw-all-options">
            ...
            <p>
                ...
                <select name="<?php echo $this->get_field_name('orderby'); ?>" id="<?php echo $this->get_field_id('orderby'); ?>" class="widefat">
                    ...
                    <option value="term_group" <?php if ($orderby == 'term_group') {
                                                    echo 'selected="selected"';
                                                } ?>>Term Group</option>
                </select>
            </p>
...
/* ----------------------------------------------
    Register 'Custom Taxonomy' widget End here
-------------------------------------------*/